...
typedef ap_fixed<24,12,AP_RND,AP_SAT> input_t;
typedef ap_fixed<24,12,AP_RND,AP_SAT> layer2_t;
typedef ap_fixed<24,12,AP_RND,AP_SAT> batchnorm_inputs_default_t;
typedef ap_fixed<16,6> model_default_t;
typedef ap_fixed<16,6> layer26_t;
typedef ap_fixed<9,3> qdense_phi_1_weight_t;
typedef ap_fixed<9,3> qdense_phi_1_bias_t;
typedef ap_ufixed<9,0,AP_RND_CONV,AP_SAT> layer5_t;
...
typedef ap_ufixed<9,0,AP_RND_CONV,AP_SAT> layer8_t;
typedef ap_fixed<18,8> qActivation_phi_2_table_t;
typedef ap_fixed<18,9,AP_RND_CONV,AP_SAT> layer9_t;
...
typedef ap_ufixed<9,0,AP_RND_CONV,AP_SAT> layer18_t;
typedef ap_fixed<18,8> qActivation_2_class_table_t;
typedef ap_ufixed<9,0,AP_RND_CONV,AP_SAT> layer19_t;
...
typedef ap_fixed<24,12,AP_RND,AP_SAT> layer24_t;
typedef ap_fixed<18,8> output_class_table_t;
typedef ap_fixed<18,8,AP_RND,AP_SAT> output_class_exp_table_t;
typedef ap_fixed<18,8,AP_RND,AP_SAT> output_class_inv_table_t;
typedef ap_fixed<24,12,AP_RND,AP_SAT> layer25_t;
typedef ap_fixed<18,8> output_reg_table_t;
